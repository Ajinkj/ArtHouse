...
class EventRegisterForm(ModelForm):
	class Meta:
		...
		widgets={'customer':forms.HiddenInput,'event_name':forms.HiddenInput,'Proposed_Date': forms.TextInput(attrs={'class': 'form-control', 'type': 'date'}),
            'Proposed_Time': forms.TextInput(attrs={'class': 'form-control', 'type': 'time'}),}
...
class UpdateRegisterForm(ModelForm):
	class Meta:
		...
		widgets={'Proposed_Date': forms.TextInput(attrs={'class': 'form-control', 'type': 'date'}),
            'Proposed_Time': forms.TextInput(attrs={'class': 'form-control', 'type': 'time'}),}
